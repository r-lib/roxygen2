...
* R6 improvements:
  ...
  * New `@R6method Class$method` tag allows you to document R6 methods anywhere, in case you generating them in a way that roxygen2 doesn't currently recognise (#991).
