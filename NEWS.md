...
* R6 improvements:
  * R6 method usage now shows `ClassName(args)` for constructors and `obj$method(args)` for other methods, making it clearer how each method is actually called (#1026).
