...
made_by <- function(comment) {
  pkgV <- getOption("roxygen2.pkg.version",TRUE)
  roxygen2_version <- if(isTRUE(pkgV)) paste0(" (", packageVersion("roxygen2"),")") else ""
  paste0(comment, " Generated by roxygen2",roxygen2_version,": do not edit by hand\n")
}
