...
[`roxygenize()`](https://roxygen2.r-lib.org/reference/roxygenize.md) and
the key data structures that power it. Then we’ll show you how you can
use its two extension points:
...
[`roxygenize()`](https://roxygen2.r-lib.org/reference/roxygenize.md) (or
`devtools::document()`) a bunch without ever really thinking about
...
- Finds the roclets (see
  [`roclet()`](https://roxygen2.r-lib.org/reference/roclet.md)) from its
  `roclets` argument or the “roclets” option
  ([`load_options()`](https://roxygen2.r-lib.org/reference/load_options.md)).
...
[`roxy_block()`](https://roxygen2.r-lib.org/reference/roxy_block.md) is
to generate one by parsing a roxygen block with
...
[`rd_section()`](https://roxygen2.r-lib.org/reference/rd_section.md) is
...
other
packages](https://roxygen2.r-lib.org/articles/rd-S3.html#methods-for-generics-in-other-packages).
...
[`roclet()`](https://roxygen2.r-lib.org/reference/roclet.md). Our `memo`
roclet doesn’t have any options so this is very simple:
...
[`roxygenize()`](https://roxygen2.r-lib.org/reference/roxygenize.md) at
all.

[^1]: For example, the no-longer recommended
    [`vignette_roclet()`](https://roxygen2.r-lib.org/reference/vignette_roclet.md)
