...
There are three basic forms for linking to topics in the current package
or its dependencies.
...
You can also provide your own link text. In this case there’s no
advantage to supplying a function call, as you control the formatting of
the text.
...
`devtools::document()`) to generate the Rd files. This potentially makes
