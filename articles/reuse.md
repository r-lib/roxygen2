...
Here’s a simple example, which will greet the user appropriately,
...
Note that compared to inline R code, the function is run in the global
environment by R’s documentation system, not inside the package
