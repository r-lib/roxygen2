...
- [`escape_examples()`](https://roxygen2.r-lib.org/dev/reference/escape_examples.md)
  is now exported
...
- [`load_pkgload()`](https://roxygen2.r-lib.org/dev/reference/load.md),
  the default, uses [pkgload](https://github.com/r-lib/pkgload).
  Compared to the previous release, this now automatically recompiles
...
- [`roclet_tags()`](https://roxygen2.r-lib.org/dev/reference/roclet.md)
...
- `global_options` is no longer passed to all roclet methods. Instead,
  use
  [`roxy_meta_get()`](https://roxygen2.r-lib.org/dev/reference/load_options.md)
  to retrieve values stored in the options
  ([\#918](https://github.com/r-lib/roxygen2/issues/918)).

- [`tag_two_part()`](https://roxygen2.r-lib.org/dev/reference/tag_parsers.md)
  and
  [`tag_words()`](https://roxygen2.r-lib.org/dev/reference/tag_parsers.md)
...
- [`parse_package()`](https://roxygen2.r-lib.org/dev/reference/parse_package.md),
  [`parse_file()`](https://roxygen2.r-lib.org/dev/reference/parse_package.md)
...
- [`roclet()`](https://roxygen2.r-lib.org/dev/reference/roclet.md) (the
  constructor),
  [`roclet_tags()`](https://roxygen2.r-lib.org/dev/reference/roclet.md),
  [`roclet_process()`](https://roxygen2.r-lib.org/dev/reference/roclet.md)
...
- `new_roclet()` is no longer exported - use
  [`roclet()`](https://roxygen2.r-lib.org/dev/reference/roclet.md)
  instead.
...
- Export
  [`is_s3_method()`](https://roxygen2.r-lib.org/dev/reference/is_s3_generic.md).
