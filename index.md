...
When you
[`roxygenise()`](https://roxygen2.r-lib.org/reference/roxygenize.md) (or
`devtools::document()`) your package these comments will be
...
- [`vignette("namespace")`](https://roxygen2.r-lib.org/articles/namespace.md)
