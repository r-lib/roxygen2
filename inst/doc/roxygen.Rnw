...
\ref{pseudoprime-package}; notice the \texttt{NULL} statement in
...
lieu of a specific function. \texttt{NULL} is provided as a
...
terminated by \texttt{NULL}; \texttt{@include fermat.R} (line 1)
