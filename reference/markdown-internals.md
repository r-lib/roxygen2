...
parsing is done. The fragile tags are listed in `escaped_for_md`. A
fragile tag is protected together with all of its brace arguments, so
markdown is never interpreted inside them.
