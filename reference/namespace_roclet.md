...
This [roclet](https://roxygen2.r-lib.org/reference/roclet.md) automates
the production of a `NAMESPACE` file, which controls the functions
imported and exported by your package, as described in [Writing R
