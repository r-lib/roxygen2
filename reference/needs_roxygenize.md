...
faster than running
[`roxygenize()`](https://roxygen2.r-lib.org/reference/roxygenize.md) but
can suffer from both false negatives (e.g. if an inherited documentation
topic has changed) and false positives (e.g. if a source file was
modified but the change doesn't affect the documentation).
