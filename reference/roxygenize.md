...
[roclets](https://roxygen2.r-lib.org/reference/roclet.md), roxygen2's
plugin system for producing different types of output. See the
...
- roclets:
  ...
  Character vector of
  [roclets](https://roxygen2.r-lib.org/reference/roclet.md) to use.
...
- load_code:
  ...
  [`load_pkgload()`](https://roxygen2.r-lib.org/reference/load.md). See
  [load](https://roxygen2.r-lib.org/reference/load.md) for more details.
