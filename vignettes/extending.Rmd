...
To use your new tags in another package, you must tell roxygen to load that package in order to find the new tags. For example, if you created some new tags in {packageFoo}, and would like to use these tags in your documentation for {packageBar}, append this like to the `DESCRIPTION` of {packageBar}:
