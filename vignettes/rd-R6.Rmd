...
Documenting [R6 classes](https://adv-r.hadley.nz/r6.html) well requires thinking about three things:
...
`@param` tags that appear at the class level (i.e.
before the `R6Class()` call) are automatically inherited by all methods, if needed.
