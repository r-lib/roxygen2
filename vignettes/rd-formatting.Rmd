...
vignette: >
  %\VignetteIndexEntry{Markdown support}
...
We expect most roxygen2 user will write documentation using markdown since it's familiar, and doesn't require learning any new syntax.
