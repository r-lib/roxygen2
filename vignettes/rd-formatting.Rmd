...
When mixing `Rd` and Markdown notation, most `Rd` tags may contain Markdown markup, the ones that can *not* are: `r paste0("\x60\\", roxygen2:::verbatim_rd_tags, "\x60", collapse = ", ")`.
