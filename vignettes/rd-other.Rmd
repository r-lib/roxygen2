...
Note that the default usage assumes that you use `LazyData: true` in your `DESCRIPTION`; this is the recommended (modern) style of exposing datasets and doesn't require an explicit `data()` call.
