...
```{r, code = brio::read_lines("../tests/testthat/roxygen-block-describe-in-functions.R")}
```
...
1. Your new methods will be listed in a subsection titled "**Methods (by generic)**"
    ...
    ```{r, code = brio::read_lines("../tests/testthat/roxygen-block-describe-in-by-generic.R")}
    ```
...
2. If the function you are `@describeIn` *in* is a generic, your new methods for 
    ...
    ```{r, code = brio::read_lines("../tests/testthat/roxygen-block-describe-in-by-class.R")}
    ```
