...
```{r, child = "../tests/testthat/test-rd-describe-in-simple.Rmd"}
```
...
1. Your new methods will be listed in a subsection titled "**Methods (by generic)**"
    ...
    ```{r, child = "../tests/testthat/test-rd-describe-in-by-generic.Rmd"}
    ```
...
2. If the function you are `@describeIn` *in* is a generic, your new methods for 
    ...
    ```{r, child = "../tests/testthat/test-rd-describe-in-by-class.Rmd"}
    ```
