...
`usethis::use_package_doc()` will generate a basic template for you automatically.
...
*   Use `@keywords keyword1 keyword2 ...` to add standardised keywords. 
    ...
    Keywords are not very useful, except for `@keywords internal`. Using 
    the internal keyword removes the function from the documentation index 
    and is useful for functions aimed primarily at other developers, not
    typically users of the package.
