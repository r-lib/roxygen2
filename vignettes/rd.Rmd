...
*   `@examples` provides executable R code showing how to use the function in
    ...
    Moreover you can include example code from a function body of a
    non-exported function from your package by
    `@exampleFunction example_myFunction`
    But you need to run `roxygenize` from the package root, else
    the non-exported function will not be found.
