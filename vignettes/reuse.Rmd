...
This is useful for documentation that needs to be dynamic, reflecting the current state of R, not the state when the package was built.
...
Note that compared to inline R code, the function is run in the global environment by R's documentation sysytem, not inside the package namespace by roxygen2. 
