...
```{r, code = readLines("../tests/testthat/roxygen-block-describe-in-functions.R")}
```
...
2.  If your new method extends another generic, for a class constructed in the destination, it will be listed in a subsection titled "**Methods extending `<destination>` class (by generic)**" It will be labelled by the generic which the method extends.
