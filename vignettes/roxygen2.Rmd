...
When you request documentation, R then converts this file into the display you're used to seeing.
...
If you use explicit tags, you can put them in any order and still get the same output.
